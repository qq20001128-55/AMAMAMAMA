  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-[var(--text-muted,#9ca3af)] tracking-widest mt-4 leading-loose">
      ...
      <div className="space-y-12">
        ...
        <section className="window-box">
          ...
          <p className="text-[var(--text-muted,#9ca3af)] mb-6 tracking-widest text-sm">適合習慣轉帳或無信用卡的委託人。</p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-[var(--border-color,#374151)]">
                <tr className="hover:bg-[var(--box-bg-color,#1a1a1a)] transition-colors">
                  <td className="py-4 px-4 tracking-widest">虛擬帳號 / ATM</td>
                  <td className="py-4 px-4 tracking-widest text-[var(--text-muted,#9ca3af)]">智慧 ATM 2.0、網路轉帳</td>
                ...
                <tr className="hover:bg-[var(--box-bg-color,#1a1a1a)] transition-colors">
                  ...
                  <td className="py-4 px-4 tracking-widest text-[var(--text-muted,#9ca3af)]">至便利商店機台輸入代碼繳費</td>
                  <td className="py-4 px-4 tracking-widest font-mono">28 元 / 筆</td>
                </tr>
                <tr className="hover:bg-[var(--box-bg-color,#1a1a1a)] transition-colors">
                  <td className="py-4 px-4 tracking-widest">條碼繳費</td>
                  <td className="py-4 px-4 tracking-widest text-[var(--text-muted,#9ca3af)]">出示手機條碼至櫃檯掃描</td>
        ...
        <section className="neo-box mt-12 bg-black/40 backdrop-blur-sm">
          ...
          <ul className="space-y-4 tracking-widest text-sm leading-relaxed">
            <li className="flex gap-4">
              ...
              <span className="text-[var(--text-muted,#9ca3af)]">請於確認排單後 3 日內完成付款，逾期將自動取消名額。</span>
            </li>
            <li className="flex gap-4">
              <span className="font-bold min-w-[80px]">退款規範：</span>
              <span className="text-[var(--text-muted,#9ca3af)]">若因委託人因素中途取消，手續費（藍新金流端已扣除部分）將無法退還，僅針對剩餘委託款項依進度比例退費。</span>
            </li>
            <li className="flex gap-4">
              <span className="font-bold min-w-[80px]">發票資訊：</span>
              <span className="text-[var(--text-muted,#9ca3af)]">交易完成後，電子發票將由藍新金流發送至您的電子信箱。</span>
            </li>
          </ul>
        </section>
      </div>
