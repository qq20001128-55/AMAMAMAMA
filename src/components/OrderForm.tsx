      ...
      >
        ...
        <div className="window-box-octagon mb-10">
          ...
          <div className="prose prose-sm max-w-none text-gray-300 space-y-6 leading-loose tracking-widest text-center flex flex-col items-center">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">二、 關於修改 (Revision Policy)</h3>
              <ul className="list-none space-y-2 p-0 m-0">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">三、 關於退費與終止 (Refund Policy)</h3>
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">四、 關於「驚喜包」特別條款</h3>
              <ul className="list-none space-y-2 p-0 m-0">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">五、 其他條款</h3>
              <ul className="list-none space-y-2 p-0 m-0">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <input 
            ...
            className="w-5 h-5 border-2 border-[var(--theme-color,#d4af37)] rounded-none focus:ring-0 cursor-pointer accent-[#53565b]"
          />
      ...
      >
        ...
        <div className="window-box-octagon mb-10">
          ...
          <div className="prose prose-sm max-w-none text-gray-300 space-y-6 leading-loose tracking-widest text-center flex flex-col items-center">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">一、 非商業委託 (Non-Commercial / Personal Use)</h3>
              <ul className="list-none space-y-2 p-0 m-0">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">二、 商業委託 (Commercial Use)</h3>
              <ul className="list-none space-y-2 p-0 m-0">
            ...
            <div className="w-full max-w-lg text-center">
              <h3 className="font-bold text-lg border-b-2 border-[var(--theme-color,#d4af37)] inline-block mb-3">三、 著作權買斷 (Buyout / Full Rights Transfer)</h3>
              <ul className="list-none space-y-2 p-0 m-0">
              ...
              <div className="mt-4">
                <p className="font-bold text-sm mb-2 text-[var(--theme-color,#d4af37)]">買斷條款建議：</p>
                <ul className="list-none space-y-2 p-0 m-0">
    ...
    return (
      ...
      >
        <div className="flex justify-center mb-6">
          <div className="w-20 h-20 border-4 border-[var(--theme-color,#d4af37)] rounded-full flex items-center justify-center text-[var(--theme-color,#d4af37)]">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {previews.map((preview, index) => (
                  <div key={index} className="relative aspect-square border-2 border-[var(--theme-color,#d4af37)] overflow-hidden group">
